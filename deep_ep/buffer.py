...
class Buffer:
    ...
    def __init__(self, group: Optional[dist.ProcessGroup],
        ...
        if self.runtime.get_num_rdma_ranks() > 1 or low_latency_mode:
            ...
            os.environ['NVSHMEM_IBGDA_NUM_RC_PER_PE'] = os.environ['NVSHMEM_IBGDA_NUM_RC_PER_PE'] if os.environ['NVSHMEM_IBGDA_NUM_RC_PER_PE'] is not None else f'{num_qps_per_rank}'
